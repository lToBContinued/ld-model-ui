...
import { autocompletion, closeBrackets, type Completion, pickedCompletion } from '@codemirror/autocomplete'
...
//将非叶子节点也高亮，修改placeholderMatcher
